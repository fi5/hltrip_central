...
public class GroupTourProductSetMealDaoImpl implements GroupTourProductSetMealDao {
    ...
    @Override
    public GroupTourProductSetMealMPO getSetMealById(String setMealId){
        return mongoTemplate.findOne(new Query(Criteria.where("_id").is(setMealId)), GroupTourProductSetMealMPO.class);
    }
}
